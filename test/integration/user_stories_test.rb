...
class UserStoriesTest < ActionDispatch::IntegrationTest
  ...
  # adding it to their cart, and check out,
  # filling in their details on the checkout form.
  # When they submit,
  # an order is created containing their information,
  # along with a
  # single line item corresponding to the product
  ...
  test 'buying a product' do
    ...
    perform_enqueued_jobs do
      ...
      assert_equal 'Depot Agency <nhomwebgame@gmail.com>', mail[:from].value
